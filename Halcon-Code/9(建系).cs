...
public partial class HDevelopExport
{
  ...
  public void gen_Edge_Circle (HObject ho_Image, out HObject ho_Circle, HTuple hv_CenterRow, 
  ...
  public void gen_FitPoint (out HObject ho_Circle1, HTuple hv_Origin_Row_InImg, HTuple hv_Origin_Column_InImg, 
  ...
  private void action()
  {
    ...
    HObject ho_Circle4, ho_Contour, ho_ContCircle;
    ...
    HTuple hv_p4_YOffest = new HTuple(), hv_CircleRadius = new HTuple();
    HTuple hv_PositionDegrees = new HTuple(), hv_X1s = new HTuple();
    HTuple hv_Y1s = new HTuple(), hv_RunTime = new HTuple();
    HTuple hv_StartTime = new HTuple(), hv_TwoCirclePhi = new HTuple();
    ...
    HTuple hv_RightRowEdge1 = new HTuple(), hv_RightColumnEdge1 = new HTuple();
    HTuple hv_RightRowEdge2 = new HTuple(), hv_RightColumnEdge2 = new HTuple();
    HTuple hv_Origin_Row_InImg = new HTuple(), hv_Origin_Column_InImg = new HTuple();
    HTuple hv_IsOverlapping = new HTuple(), hv_p1_x = new HTuple();
    HTuple hv_p1_y = new HTuple(), hv_p2_x = new HTuple();
    HTuple hv_p2_y = new HTuple(), hv_p3_x = new HTuple();
    HTuple hv_p3_y = new HTuple(), hv_p4_x = new HTuple();
    HTuple hv_p4_y = new HTuple(), hv_FitCircleCenterRow = new HTuple();
    HTuple hv_FitCircleCenterCol = new HTuple(), hv_FitCircleCenterRadius = new HTuple();
    HTuple hv_StartPhi = new HTuple(), hv_EndPhi = new HTuple();
    HTuple hv_PointOrder = new HTuple(), hv_X1 = new HTuple();
    HTuple hv_Y1 = new HTuple(), hv_StopTime = new HTuple();
    HTuple hv_runtime = new HTuple(), hv_CircleRadiu = new HTuple();
    ...
    hv_PixclRealDis = 0.009443;
    hv_p1_XOffest.Dispose();
    using (HDevDisposeHelper dh = new HDevDisposeHelper())
    {
    hv_p1_XOffest = 22.820/0.009443;
    }
    hv_p1_YOffest.Dispose();
    using (HDevDisposeHelper dh = new HDevDisposeHelper())
    {
    hv_p1_YOffest = 3.312/0.009443;
    }

    hv_p2_XOffest.Dispose();
    using (HDevDisposeHelper dh = new HDevDisposeHelper())
    {
    hv_p2_XOffest = 16.390/0.009443;
    }
    hv_p2_YOffest.Dispose();
    using (HDevDisposeHelper dh = new HDevDisposeHelper())
    {
    hv_p2_YOffest = 3.312/0.009443;
    }

    hv_p3_XOffest.Dispose();
    using (HDevDisposeHelper dh = new HDevDisposeHelper())
    {
    hv_p3_XOffest = 16.390/0.009443;
    }
    hv_p3_YOffest.Dispose();
    using (HDevDisposeHelper dh = new HDevDisposeHelper())
    {
    hv_p3_YOffest = 10.264/0.009443;
    }

    hv_p4_XOffest.Dispose();
    using (HDevDisposeHelper dh = new HDevDisposeHelper())
    {
    hv_p4_XOffest = 22.820/0.009443;
    }
    hv_p4_YOffest.Dispose();
    using (HDevDisposeHelper dh = new HDevDisposeHelper())
    {
    hv_p4_YOffest = 10.264/0.009443;
    }

    hv_CircleRadius.Dispose();
    hv_CircleRadius = new HTuple();
    hv_PositionDegrees.Dispose();
    hv_PositionDegrees = new HTuple();
    hv_X1s.Dispose();
    hv_X1s = new HTuple();
    hv_Y1s.Dispose();
    hv_Y1s = new HTuple();
    ...
    gen_TwoCircle_info(Image, MaxCircleRow, MaxCircleColumn, MaxCircleRadius, MinCircleRow, MinCircleColumn, MinCircleRadius, TwoCirclePhi);
        //定位底部测量矩形
    gen_buttom_edge(Image, MaxCircleRow, MaxCircleColumn, MaxCircleRadius * 3 / 2, MaxCircleRadius * 3 / 4, TwoCirclePhi, Width, Height, rad(90), rad(90), MinCircleColumn, MaxCircleColumn, ButtomRowEdge1, ButtomColumnEdge1, ButtomRowEdge2, ButtomColumnEdge2);
        //定位右侧测量矩形
    gen_right_edge(Image, MinCircleRow, MinCircleColumn, MinCircleRadius * 3 / 4, MinCircleRadius * 6 / 5, MaxCircleColumn, TwoCirclePhi, Width, Height, rad(180), 0, RightRowEdge1, RightColumnEdge1, RightRowEdge2, RightColumnEdge2);
    //求底部边缘和右侧边缘交点，即坐标原点
    hv_Origin_Row_InImg.Dispose();hv_Origin_Column_InImg.Dispose();hv_IsOverlapping.Dispose();
    HOperatorSet.IntersectionLines(hv_ButtomRowEdge1, hv_ButtomColumnEdge1, hv_ButtomRowEdge2, 
        hv_ButtomColumnEdge2, hv_RightRowEdge1, hv_RightColumnEdge1, hv_RightRowEdge2, 
        hv_RightColumnEdge2, out hv_Origin_Row_InImg, out hv_Origin_Column_InImg, 
        out hv_IsOverlapping);
    //求取4个拟合点
    ho_Circle1.Dispose();hv_p1_x.Dispose();hv_p1_y.Dispose();
    gen_FitPoint(out ho_Circle1, hv_Origin_Row_InImg, hv_Origin_Column_InImg, hv_TwoCirclePhi, 
        hv_p1_XOffest, hv_p1_YOffest, out hv_p1_x, out hv_p1_y);
    ho_Circle2.Dispose();hv_p2_x.Dispose();hv_p2_y.Dispose();
    gen_FitPoint(out ho_Circle2, hv_Origin_Row_InImg, hv_Origin_Column_InImg, hv_TwoCirclePhi, 
        hv_p2_XOffest, hv_p2_YOffest, out hv_p2_x, out hv_p2_y);
    ho_Circle3.Dispose();hv_p3_x.Dispose();hv_p3_y.Dispose();
    gen_FitPoint(out ho_Circle3, hv_Origin_Row_InImg, hv_Origin_Column_InImg, hv_TwoCirclePhi, 
        hv_p3_XOffest, hv_p3_YOffest, out hv_p3_x, out hv_p3_y);
    ho_Circle4.Dispose();hv_p4_x.Dispose();hv_p4_y.Dispose();
    gen_FitPoint(out ho_Circle4, hv_Origin_Row_InImg, hv_Origin_Column_InImg, hv_TwoCirclePhi, 
        hv_p4_XOffest, hv_p4_YOffest, out hv_p4_x, out hv_p4_y);
    //利用4个拟合点生成点多边形轮廓，并拟合成圆
    using (HDevDisposeHelper dh = new HDevDisposeHelper())
    {
    ho_Contour.Dispose();
    HOperatorSet.GenContourPolygonXld(out ho_Contour, ((((hv_p1_y.TupleConcat(hv_p2_y))).TupleConcat(
        hv_p3_y))).TupleConcat(hv_p4_y), ((((hv_p1_x.TupleConcat(hv_p2_x))).TupleConcat(
        hv_p3_x))).TupleConcat(hv_p4_x));
    }
    hv_FitCircleCenterRow.Dispose();hv_FitCircleCenterCol.Dispose();hv_FitCircleCenterRadius.Dispose();hv_StartPhi.Dispose();hv_EndPhi.Dispose();hv_PointOrder.Dispose();
    HOperatorSet.FitCircleContourXld(ho_Contour, "atukey", -1, 0, 0, 3, 1, out hv_FitCircleCenterRow, 
        out hv_FitCircleCenterCol, out hv_FitCircleCenterRadius, out hv_StartPhi, 
        out hv_EndPhi, out hv_PointOrder);
    using (HDevDisposeHelper dh = new HDevDisposeHelper())
    {
    ho_ContCircle.Dispose();
    HOperatorSet.GenCircleContourXld(out ho_ContCircle, hv_FitCircleCenterRow, hv_FitCircleCenterCol, 
        hv_FitCircleCenterRadius, 0, (new HTuple(360)).TupleRad(), "positive", 1);
    }
    //计算X1
    hv_X1.Dispose();
    ...
    using (HDevDisposeHelper dh = new HDevDisposeHelper())
    {
    hv_CircleRadiu = (hv_FitCircleCenterRadius*2)*0.009443;
    }
    ...
    {
    HTuple 
      ExpTmpLocalVar_CircleRadius = hv_CircleRadius.TupleConcat(
        hv_CircleRadiu);
    hv_CircleRadius.Dispose();
    hv_CircleRadius = ExpTmpLocalVar_CircleRadius;
    }
    }
    using (HDevDisposeHelper dh = new HDevDisposeHelper())
    {
    {
    HTuple 
      ExpTmpLocalVar_PositionDegrees = hv_PositionDegrees.TupleConcat(
        hv_PositionDegree);
    hv_PositionDegrees.Dispose();
    hv_PositionDegrees = ExpTmpLocalVar_PositionDegrees;
    }
    }
    using (HDevDisposeHelper dh = new HDevDisposeHelper())
    {
    {
    HTuple 
      ExpTmpLocalVar_X1s = hv_X1s.TupleConcat(
        hv_X1*0.009443);
    hv_X1s.Dispose();
    hv_X1s = ExpTmpLocalVar_X1s;
    }
    }
    using (HDevDisposeHelper dh = new HDevDisposeHelper())
    {
    {
    HTuple 
      ExpTmpLocalVar_Y1s = hv_Y1s.TupleConcat(
        hv_Y1*0.009443);
    hv_Y1s.Dispose();
    hv_Y1s = ExpTmpLocalVar_Y1s;
    }
    }
    using (HDevDisposeHelper dh = new HDevDisposeHelper())
    {
    {
    HTuple 
      ExpTmpLocalVar_RunTime = hv_RunTime.TupleConcat(
        hv_runtime);
    hv_RunTime.Dispose();
    hv_RunTime = ExpTmpLocalVar_RunTime;
    }
    }
