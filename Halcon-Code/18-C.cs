...
public partial class HDevelopExport
{
  ...
  public void get_median_grayVal_point_to_circle (HObject ho_Image, HTuple hv_point_y, 
  ...
  public void get_median_grayVal_point_to_rect (HObject ho_Image, HTuple hv_point_y, 
      HTuple hv_point_x, HTuple hv_height, HTuple hv_width, out HTuple hv_Median)
  {
    ...
    HOperatorSet.GenRectangle1(out ho_Rectangle, hv_point_y, hv_point_x, hv_point_y+hv_height, 
        hv_point_x+hv_width);
    }
    ho_Contours.Dispose();
    HOperatorSet.GenContourRegionXld(ho_Rectangle, out ho_Contours, "center");
    hv_Grayval.Dispose();
    HOperatorSet.GetGrayvalContourXld(ho_Image, ho_Contours, "nearest_neighbor", 
        out hv_Grayval);
    hv_Median.Dispose();
  ...
  public void get_median_grayVal_point_to_region (HObject ho_Image, out HObject ho_circle_Radius, 
      HTuple hv_point_y, HTuple hv_point_x, out HTuple hv_Median)
  {
    ...
    HTuple hv_Grayval = new HTuple();
    // Initialize local and output iconic variables 
    HOperatorSet.GenEmptyObj(out ho_circle_Radius);
    HOperatorSet.GenEmptyObj(out ho_Contours);
    hv_Median = new HTuple();
    ho_circle_Radius.Dispose();
    HOperatorSet.GenCircle(out ho_circle_Radius, hv_point_y, hv_point_x, 5);
    ho_Contours.Dispose();
    HOperatorSet.GenContourRegionXld(ho_circle_Radius, out ho_Contours, "center");
    hv_Grayval.Dispose();
    HOperatorSet.GetGrayvalContourXld(ho_Image, ho_Contours, "nearest_neighbor", 
        out hv_Grayval);
    hv_Median.Dispose();
  ...
  public void my_create_coordinate (HTuple hv_HomMat2DIdentity, HTuple hv_Col_Origin, 
      HTuple hv_Row_Origin, HTuple hv_ColEnd_X, HTuple hv_RowEnd_X, HTuple hv_WindowHandle, 
      out HTuple hv_Phi)
  {
    ...
    HTuple hv_HomMat2DRotate = new HTuple(), hv_ColEnd_Y = new HTuple();
    HTuple hv_RowEnd_Y = new HTuple();
    // Initialize local and output iconic variables 
    hv_Phi = new HTuple();
    using (HDevDisposeHelper dh = new HDevDisposeHelper())
    {
    ...
    HOperatorSet.DispArrow(hv_WindowHandle, hv_Row_Origin, hv_Col_Origin, hv_RowEnd_X, 
        hv_ColEnd_X, 5);
    HOperatorSet.DispArrow(hv_WindowHandle, hv_Row_Origin, hv_Col_Origin, hv_RowEnd_Y, 
        hv_ColEnd_Y, 5);
  ...
  public void my_fit_surface (HObject ho_ImageZ, HTuple hv_HomMat2DIdentity, HTuple hv_p_A1_x_offest, 
      ...
      HTuple hv_WindowHandle, HTuple hv_p_A2_x_offest, HTuple hv_p_A2_y_offest, HTuple hv_p_A3_x_offest, 
  ...
  public void my_gen_4point_offest (HObject ho_ImageZ, HTuple hv_HomMat2DIdentity, 
      ...
      HTuple hv_Row_Origin, HTuple hv_WindowHandle, HTuple hv_p_E5_x_offest, HTuple hv_p_E5_y_offest, 
      ...
      out HTuple hv_E10_Z_mm, out HTuple hv_E13_Z_mm)
  {
    ...
    HTuple hv_p_E2_x_fit = new HTuple(), hv_p_E2_y_fit = new HTuple();
    HTuple hv_p_E5_x_fit = new HTuple(), hv_p_E5_y_fit = new HTuple();
    HTuple hv_p_E10_x_fit = new HTuple(), hv_p_E10_y_fit = new HTuple();
    HTuple hv_p_E13_x_fit = new HTuple(), hv_p_E13_y_fit = new HTuple();
    ...
    my_gen_suffce_fit_point(hv_Row_Origin, hv_Col_Origin, hv_Phi, hv_p_E2_x_offest, 
        hv_p_E2_y_offest, hv_WindowHandle, out hv_p_E2_x_fit, out hv_p_E2_y_fit);
    hv_p_E5_x_fit.Dispose();hv_p_E5_y_fit.Dispose();
    my_gen_suffce_fit_point(hv_Row_Origin, hv_Col_Origin, hv_Phi, hv_p_E5_x_offest, 
        hv_p_E5_y_offest, hv_WindowHandle, out hv_p_E5_x_fit, out hv_p_E5_y_fit);
    ...
    my_gen_suffce_fit_point(hv_Row_Origin, hv_Col_Origin, hv_Phi, hv_p_E10_x_offest, 
        hv_p_E10_y_offest, hv_WindowHandle, out hv_p_E10_x_fit, out hv_p_E10_y_fit);
    ...
    my_gen_suffce_fit_point(hv_Row_Origin, hv_Col_Origin, hv_Phi, hv_p_E13_x_offest, 
        hv_p_E13_y_offest, hv_WindowHandle, out hv_p_E13_x_fit, out hv_p_E13_y_fit);
  ...
  public void my_gen_suffce_fit_point (HTuple hv_Row_Origin, HTuple hv_Col_Origin, 
      HTuple hv_Phi, HTuple hv_p_A1_x_offest, HTuple hv_p_A1_y_offest, HTuple hv_WindowHandle, 
      out HTuple hv_p_A_x_fit, out HTuple hv_p_A_y_fit)
  {
    ...
    //p_A_YInBase := Row_Origin_InBase-p_A1_y_offest-20
    ...
    HOperatorSet.DispCircle(hv_WindowHandle, hv_p_A_y_fit, hv_p_A_x_fit, 10);
  ...
  private void action()
  {
    ...
    HObject ho_ImageZ=null, ho_ImageScaled=null;
    ...
    HTuple hv_Z_Origin = new HTuple(), hv_E2_Z = new HTuple();
    HTuple hv_E5_Z = new HTuple(), hv_E10_Z = new HTuple();
    HTuple hv_E13_Z = new HTuple(), hv_Profile = new HTuple();
    ...
    HTuple hv_E13_Z_mm = new HTuple(), hv_result = new HTuple();
    HTuple hv_Max = new HTuple(), hv_Min = new HTuple(), hv_error = new HTuple();
    // Initialize local and output iconic variables 
    ...
    hv_E13_Z = new HTuple();
    hv_Profile.Dispose();
    hv_Profile = new HTuple();
    if (HDevWindowStack.IsOpen())
    {
      HOperatorSet.CloseWindow(HDevWindowStack.Pop());
    }
    HOperatorSet.SetWindowAttr("background_color","black");
    HOperatorSet.OpenWindow(0,0,640,500,0,"visible","",out hv_WindowHandle);
    HDevWindowStack.Push(hv_WindowHandle);

    hv_ImageFiles.Dispose();
    list_image_files("//mac/Home/Desktop/VirtualProject/Data/3d-Image/18", "default", 
        new HTuple(), out hv_ImageFiles);
        ...
        ))-1); hv_Index = (int)hv_Index + 1)
    {
      ...
      {
      ho_ImageZ.Dispose();
      HOperatorSet.ReadImage(out ho_ImageZ, hv_ImageFiles.TupleSelect(hv_Index));
      }
      hv_Width.Dispose();hv_Height.Dispose();
      HOperatorSet.GetImageSize(ho_ImageZ, out hv_Width, out hv_Height);

      ho_ImageScaled.Dispose();
      HOperatorSet.ScaleImage(ho_ImageZ, out ho_ImageScaled, 0.190441, -4425);
      ...
      gen_TwoCircle_info(ho_ImageScaled, out hv_Row_Origin, out hv_Col_Origin, out hv_MaxCircleRadius, 
      ...
      my_create_coordinate(hv_HomMat2DIdentity, hv_Col_Origin, hv_Row_Origin, hv_ColEnd_X, 
          hv_RowEnd_X, hv_WindowHandle, out hv_Phi);

      //寻找拟合平面点，并计算Z0向平面的高度
      hv_Z_Origin_Median.Dispose();
      my_fit_surface(ho_ImageZ, hv_HomMat2DIdentity, hv_p_A1_x_offest, hv_p_A1_y_offest, 
          hv_Phi, hv_Col_Origin, hv_Row_Origin, hv_WindowHandle, hv_p_A2_x_offest, 
          hv_p_A2_y_offest, hv_p_A3_x_offest, hv_p_A3_y_offest, hv_p_A4_x_offest, 
          hv_p_A4_y_offest, hv_p_A5_x_offest, hv_p_A5_y_offest, hv_p_A6_x_offest, 
          hv_p_A6_y_offest, hv_p_A7_x_offest, hv_p_A7_y_offest, hv_p_A8_x_offest, 
          hv_p_A8_y_offest, out hv_Z_Origin_Median);

      //寻找底部4个点，计算四个点相对于Z0向平面的偏差
      hv_E2_Z_mm.Dispose();hv_E5_Z_mm.Dispose();hv_E10_Z_mm.Dispose();hv_E13_Z_mm.Dispose();
      my_gen_4point_offest(ho_ImageZ, hv_HomMat2DIdentity, hv_p_E2_x_offest, hv_p_E2_y_offest, 
          hv_Phi, hv_Col_Origin, hv_Row_Origin, hv_WindowHandle, hv_p_E5_x_offest, 
          hv_p_E5_y_offest, hv_p_E10_x_offest, hv_p_E10_y_offest, hv_p_E13_x_offest, 
          hv_p_E13_y_offest, hv_Z_Origin_Median, out hv_E2_Z_mm, out hv_E5_Z_mm, 
          out hv_E10_Z_mm, out hv_E13_Z_mm);
      ...
      {
      HTuple 
        ExpTmpLocalVar_Z_Origin = hv_Z_Origin.TupleConcat(
          hv_Z_Origin_Median);
      hv_Z_Origin.Dispose();
      hv_Z_Origin = ExpTmpLocalVar_Z_Origin;
      }
      }
      using (HDevDisposeHelper dh = new HDevDisposeHelper())
      {
      {
      HTuple 
        ExpTmpLocalVar_E2_Z = hv_E2_Z.TupleConcat(
          hv_E2_Z_mm);
      hv_E2_Z.Dispose();
      hv_E2_Z = ExpTmpLocalVar_E2_Z;
      }
      }
      using (HDevDisposeHelper dh = new HDevDisposeHelper())
      {
      {
      HTuple 
        ExpTmpLocalVar_E5_Z = hv_E5_Z.TupleConcat(
          hv_E5_Z_mm);
      hv_E5_Z.Dispose();
      hv_E5_Z = ExpTmpLocalVar_E5_Z;
      }
      }
      using (HDevDisposeHelper dh = new HDevDisposeHelper())
      {
      {
      HTuple 
        ExpTmpLocalVar_E10_Z = hv_E10_Z.TupleConcat(
          hv_E10_Z_mm);
      hv_E10_Z.Dispose();
      hv_E10_Z = ExpTmpLocalVar_E10_Z;
      }
      }
      using (HDevDisposeHelper dh = new HDevDisposeHelper())
      {
      {
      HTuple 
        ExpTmpLocalVar_E13_Z = hv_E13_Z.TupleConcat(
          hv_E13_Z_mm);
      hv_E13_Z.Dispose();
      hv_E13_Z = ExpTmpLocalVar_E13_Z;
      }
      }
      using (HDevDisposeHelper dh = new HDevDisposeHelper())
      {
      {
      HTuple 
        ExpTmpLocalVar_Profile = hv_Profile.TupleConcat(
          hv_result);
      hv_Profile.Dispose();
      hv_Profile = ExpTmpLocalVar_Profile;
      }
      }
      //stop ()
    }
    ...
    hv_Max.Dispose();
    HOperatorSet.TupleMax(hv_Profile, out hv_Max);
    hv_Min.Dispose();
    HOperatorSet.TupleMin(hv_Profile, out hv_Min);
    hv_error.Dispose();
    using (HDevDisposeHelper dh = new HDevDisposeHelper())
    {
    hv_error = hv_Max-hv_Min;
    }
    ho_ImageZ.Dispose();
    ho_ImageScaled.Dispose();
